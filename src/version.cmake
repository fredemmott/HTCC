...
if(LATEST_GIT_TAG STREQUAL "")
  set(LATEST_GIT_TAG "NO_TAGS")
endif()
message(STATUS "Tag: ${LATEST_GIT_TAG}")
...
if(DEFINED ENV{GITHUB_RUN_NUMBER})
  ...
  set(BUILD_TYPE "gha")
  set(BUILD_SUFFIX "${BUILD_TYPE}.${VERSION_BUILD}")
else()
...
if("${RELEASE_NAME}" STREQUAL "")
  if(MATCHING_TAG)
    set(VERSION_SEMVER "${LATEST_GIT_TAG}+${BUILD_SUFFIX}")
  else()
    set(VERSION_SEMVER "v${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_PATCH}+${BUILD_SUFFIX}")
  endif()
endif()
